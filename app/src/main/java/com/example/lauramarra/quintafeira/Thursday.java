...
public class Thursday extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuOptionsName = dbChecker.getClassName("thursday").split(";");
        menuOptionsCode = dbChecker.getClassID("thursday").split(";");
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    case 0:
                        ...
                        alertDialog = new AlertDialog.Builder(Thursday.this).create();
